...
class CalculadoraAlgebra(Frame):
    ...
    def crear_panel_lateral(self):
        ...
        botones = [
            ...
            ("Resolver Sistemas", self.mostrar_resolucion_sistemas),
    ...
    def mostrar_operaciones_combinadas(self):
        self.limpiar_area_principal()
        interfaz_operaciones_combinadas(self.area_principal, self.colores, self.fuentes)
    ...
    def mostrar_resolucion_sistemas(self):
        self.limpiar_area_principal()
        interfaz_sistemas(self.area_principal, self.colores, self.fuentes)
